						...
						<div style={{ height: '100%', width: '100%' }}>
							...
							<div>
								...
								>
									...
									>
										<Popup>
											<b>Latitude:</b> {positionRome[0]} <br />{' '}
											<b>Longitude:</b> {positionRome[1]}
										</Popup>
									</Marker>
									<Marker
									...
									>
										<Popup>
											<b>Latitude:</b> {positionParis[0]} <br />{' '}
											<b>Longitude:</b> {positionParis[1]}
										</Popup>
									</Marker>
								</MapContainer>
							</div>
